...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221113231445_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 13, 18, 14, 44, 918, DateTimeKind.Local).AddTicks(8260),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 11, 13, 18, 14, 44, 922, DateTimeKind.Local).AddTicks(2648),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 13, 18, 14, 44, 922, DateTimeKind.Local).AddTicks(2709),
                            ServicesID = 5
                        });
                });
